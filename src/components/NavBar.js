    ...
    return (
        ...
        <nav className="navbar">
            <div className='navbar-container'>
                <Link to="/" className='navbar-logo' id={"movies"} onClick={closeMobileMenu}>Movie & PopCorn< i className="fas fa-video"></i></Link>
                ...
                <ul className={click ? 'nav-menu active' : 'nav-menu'}>
                    ...
                    <li className='nav-item'><Link to="/actors" className='nav-links' id={"actors"} onClick={closeMobileMenu}>Actors</Link></li>
